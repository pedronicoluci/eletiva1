...
<?php
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($numero1 == $numero2) {
            $resultado = $soma * 3;
            echo "<p>Números iguais. O valor do triplo da soma dos dois números é igual a: $resultado.";
        }

        else
            echo "<p>Números diferentes. O resultado da soma entre os dois números é igual a: $soma.";
    }
?>
